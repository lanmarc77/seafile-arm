...
for container in ${lxcContainers[@]}; do
  ...
  sudo lxc exec $container -- su - seafile -- ./build.sh -DTA -v $VERSION -h https://raw.githubusercontent.com/ChatDeBlofeld/seafile-rpi/master/requirements/seahub_requirements_v${VERSION}.txt -d https://raw.githubusercontent.com/ChatDeBlofeld/seafile-rpi/master/requirements/seafdav_requirements_v${VERSION}.txt
